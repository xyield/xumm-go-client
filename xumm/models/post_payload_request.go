...
type XummPostPayloadOptions struct {
	...
	Pathfinding         bool                             `json:"pathfinding,omitempty"`
	PathfindingFallback bool                             `json:"pathfinding_fallback,omitempty"`
	ForceNetwork        string                           `json:"force_network,omitempty"`
}
